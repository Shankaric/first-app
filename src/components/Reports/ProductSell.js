...
setExpanded(newExpanded ? panel : false);
    ...
    return (
      <>
    <Box>
    <Typography sx={reportStyles.UnitHeaderText}>Product Sell Report</Typography>    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} sx={reportStyles.filtercontainer}>
                ...
                <Grid container spacing={2}>
                    <Grid item sm={12} xs={12} md={6} lg={3}>
                        <Grid sx={{ display: 'flex' }}  >
                            <Grid sx={reportStyles.spanIcons}><FaSearch /></Grid>
                ...
                <TableContainer component={Paper} sx={{boxShadow:'none'}}>
                    <Grid container sx={reportStyles.grid_container}>    
                        ...
                        <TableFooter sx={{height:'50px',backgroundColor:'#8080806e',textAlign:'center !important'}}>
                            <TableRow> 
                            <TableCell align="left"sx={reportStyles.footerStyle} colspan={6}>Total</TableCell>
                            <TableCell align="left"sx={reportStyles.footerStyle}>3.00 Pc(s)</TableCell>
                    ...
                    <Grid container sx={reportStyles.grid_container}>    
                        ...
                        <TableFooter sx={{height:'50px',backgroundColor:'#8080806e',}}>
                            <TableRow>
                                ...
                                <TableCell sx={reportStyles.footerStyle} align="left"> </TableCell>
                    ...
                    <Grid container sx={reportStyles.grid_container}>    
                        ...
                        <TableFooter sx={{height:'50px',backgroundColor:'#8080806e',}}>
                            <TableRow>
                                ...
                                <TableCell sx={reportStyles.footerStyle}>  </TableCell>
                                <TableCell sx={reportStyles.footerStyle}>  </TableCell>
                                <TableCell sx={reportStyles.footerStyle} align="left"> ₹0.00</TableCell>
                            </TableRow>
                        </TableFooter>
