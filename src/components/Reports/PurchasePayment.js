...
setExpanded(newExpanded ? panel : false);
    ...
    <>
    <Box>
    <Typography sx={reportStyles.UnitHeaderText}>Purchase Payment Report</Typography>
            ...
            <TableContainer component={Paper} sx={{boxShadow:'none'}}>
                            <Grid container sx={reportStyles.grid_container}>    
                                ...
                                <TableFooter sx={{height:'50px',backgroundColor:'#8080806e',textAlign:'center !important'}}>
                                    <TableRow> 
                                        <TableCell align="left"sx={reportStyles.footerStyle} colspan={2}>Total</TableCell>
