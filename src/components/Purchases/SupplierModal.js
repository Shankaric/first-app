...
import { FaInfo, FaFileCsv, FaPrint,FaPlusCircle, FaFilePdf } from "react-icons/fa";
        ...
        <Grid container spacing={4} >
                                <Grid item md={4}>
                                    <Grid sx={{ display: 'flex' }}  >
                                        <Grid sx={PurchaseStyle.grid_icons} >
                                            <PersonIcon />
                                        </Grid>
                                    ...
                                    <>
                                        <Grid item md={4} >
                                            <Grid sx={{ display: 'flex' }}  >
                                                ...
                                                <Grid sx={PurchaseStyle.grid_icons}><BusinessCenterIcon />
                                                </Grid>
                                                <FormControl size="small" fullWidth>
                                ...
                                <Grid item md={3}>
                                    <Grid sx={{ display: 'flex' }}  >
                                        <Grid sx={PurchaseStyle.grid_icons}> <MobileScreenShareIcon />
                                        </Grid>
                                        <FormControl size="small" fullWidth>
                                ...
                                <Grid item md={3}  >
                                    <Grid sx={{ display: 'flex' }}  >
                                        <Grid sx={PurchaseStyle.grid_icons}>  <MobileFriendlyIcon />
                                        </Grid>
                                        <FormControl size="small" fullWidth>
                                ...
                                <Grid item md={3}>
                                    <Grid sx={{ display: 'flex' }}  >
                                        <Grid sx={PurchaseStyle.grid_icons}> <PhoneIcon />
                                        </Grid>
                                        <FormControl size="small" fullWidth>
                                ...
                                <Grid item md={3}>
                                    <Grid sx={{ display: 'flex' }}  >
                                        <Grid sx={PurchaseStyle.grid_icons}>   <EmailIcon />
                                        </Grid>
                                        <FormControl size="small" fullWidth>
                            ...
                            {!hidden ?
                                ...
                                <Grid container spacing={4} >
                                    <Grid item md={3}>
                                        <Grid sx={{ display: 'flex' }}  >
                                            <Grid sx={PurchaseStyle.grid_icons}>   <FaInfo />
                                            </Grid>
                                            <FormControl size="small" fullWidth>
                                    ...
                                    <Grid item md={3}  >
                                        <Grid sx={{ display: 'flex' }}  >
                                            <Grid sx={PurchaseStyle.grid_icons}>    <MoneySharpIcon />
                                            </Grid>
                                            <FormControl size="small" fullWidth>
                                    ...
                                    <Grid item md={3}>
                                        <Grid sx={{ display: 'flex' }}  >
                                            <Grid sx={PurchaseStyle.grid_icons}>    <PersonIcon />
                                            </Grid>
                                            <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                    ...
                                    <Grid item md={3}>
                                        <Grid sx={{ display: 'flex' }}  >
                                            <Grid sx={PurchaseStyle.grid_icons}>     <LanguageSharpIcon />
                                            </Grid>
                                    ...
                                    <Grid item md={3}  >
                                        <Grid sx={{ display: 'flex' }}  >
                                            <Grid sx={PurchaseStyle.grid_icons}>    <LocationOnIcon />
                                            </Grid>
                                            <FormControl size="small" fullWidth>
