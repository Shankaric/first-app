                      ...
                      <Table sx={{ minWidth: 700 }} aria-label="customized table" id="example">
                        <TableHead>
                          <TableRow>
                                ...
                                <StyledTableCell> CUSTOM9</StyledTableCell>
                                <StyledTableCell> CUSTOM10</StyledTableCell>
                        ...
                        <TableBody>
                            {rows.map((row) => (
                                <TableRow
                                    ...
                                    <StyledTableCell colSpan={1}>{row.sr_credit_limit}</StyledTableCell>
                                    ...
                                    <StyledTableCell colSpan={1}>{row.sr_customer_group}</StyledTableCell>
                                    ...
                                    <StyledTableCell colSpan={1}>{row.sr_totalpurchasereturndue}</StyledTableCell>
                                    ...
                                    <StyledTableCell colSpan={1}>{row.sr_custom9}</StyledTableCell>
                                    <StyledTableCell colSpan={1}>{row.sr_custom10}</StyledTableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                        <TableFooter>
